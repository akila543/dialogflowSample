...
//     speech = "The product is " + (number2 * number1)
  ...
  var speech="hi akila how may i help you"
    return res.json({
      "fulfillmentText": speech,
      "fulfillmentMessages": [
          {
  ...
  console.log("addition logs",req.body.queryResult.outputContexts[0].parameters)
    speech = "The sum is five ";
    ...
    speech = "Tables are not available";
